     ...
     <View className="flex flex-col gap-y-[24px] h-[336px] mt-[20px] ">
      <View className="flex flex-row gap-x-[2px]  ">
        <View className="flex flex-row gap-x-[12px]  ">
          ...
          <Text className=" w-[280px] text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px] ">Settings</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
      <View className="flex flex-row gap-x-[2px] ">
        <View className="flex flex-row gap-x-[12px]">
          ...
          <Text className="w-[280px] text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px] ">Login & security</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
      <View className="flex flex-row gap-x-[2px] ">
      <View className="flex flex-row gap-x-[12px]">
          ...
          <Text className="w-[280px]  text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px] ">Help</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
      <View className="flex flex-row gap-x-[2px]">
      <View className="flex flex-row gap-x-[12px]">
          ...
          <Text className="w-[280px] text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px] ">Give us feedback</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
      <View className="flex flex-row gap-x-[2px] ">
      <View className="flex flex-row gap-x-[12px]">
          ...
          <Text className="w-[280px] text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px] ">Legal</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
      <View className="flex flex-row gap-x-[2px] ">
      <View className="flex flex-row gap-x-[12px]">
          ...
          <Text className="w-[280px] text-[17px] font-normal leading-[22px] text-[#242424] font-[400] p-[1px]">About</Text>
        </View>
        <Image source={require("../../assets/images/chevronRight.png")}/>
      </View>
