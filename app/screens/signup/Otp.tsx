...
export default function Otp() {
  return (
    <View className="bg-white h-full w-full px-5">
        <Stack.Screen
        options={{ title: "otp", headerTitleAlign: "center" }}
      />
      ...
      <View className='flex gap-[12px] mt-[20px] w-[361px]'>
        ...
        <Image
          ...
          />
            <Text>
            By selecting Agree and Continue, I agree to SwiftRide's <Text className='text-[#0078D4]'> Terms of service, Payment Terms of Service </Text> and the <Text className='text-[#0078D4]'>Privacy Policy</Text>
        </Text>
        </View>
