        ...
        <View>
          ...
          headerRight: ()=> <Trash2 color='#C50F1F' size={24} onPress={()=> setIsModalVisible(true)}/>
              ...
              <View className='justify-center'>
                ...
                <Text className='text-[13px] leading-5 tracking-[0.23px] '>You can use MTN mobile money to pay for rides by topping up your wallet balance with MTN mobile money.</Text>
              </View>
