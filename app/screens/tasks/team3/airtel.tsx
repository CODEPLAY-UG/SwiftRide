      ...
      <View>
        ...
        <View className="flex-row justify-center space-x-4 px-8">
          ...
          <Text className="text-[13px] leading-5 tracking-[0.23px] ">
            You can use Airtel mobile money to pay for rides by topping up your
            wallet balance with Airtel mobile money.
          </Text>
        </View>
        ...
        <View className="px-4 pt-12">
          <Pressable className="bg-[#F0F0F0] w-full h-[52px] items-center justify-center rounded-full">
