      ...
      <View className="">
        <View className="">
          <View className="justify-between py-5 items-center">
            <Image className="h-[170px] w-[340px] rounded-[16px]" source={require(".../../../assets/images/rider.png")} />
          </View>
        </View>
          ...
          <View className="mx-4">
            ...
            <View className="mx-2">
                ...
                <Text className="text-[#616161] text-[13px] font-normal leading-[18px] tracking-tighter[-0.08]">
                  ...
                  Your journey with Join the Community: SwiftRide is more than just an app; it’s a community of drivers and riders who value safety, reliability, and convenience.
                
              
              {"\n"}
              {"\n"}
                          Safety First: We prioritize your safety with verified drivers, real-time ride tracking, and a dedicated support team available 24/7.
        ...
        <View className="flex-row justify-between items-center mt-5">
          <View className="mx-4">
            ...
            <View className="mt-2">
              <Text className="text-[#616161] text-[13px] font-normal leading-[18px] tracking-tighter[-0.08]">
                Smart Matching: Our advanced algorithm connects you with the nearest available driver to ensure quick pickups and minimal wait times.
                {"\n"}
                {"\n"}
                Efficient Routing: SwiftRide uses real-time data to find the fastest and safest routes to your destination, avoiding traffic and delays.
              </Text>
            </View>
          </View>
        </View>
