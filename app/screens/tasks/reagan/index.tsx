  ...
  return (
    <SafeAreaView className="">
      ...
      <View className="px-[20px] gap-[16px]">
        <Text className=" pt-[8px]  pb-[24px] text-[#616161]">
      ...
      <View className="flex flex-col  px-[20px] text-[#242424]">
        <View>
          <TouchableOpacity
            ...
            className="py-[12px] h-[48px] w-[361px] flex-row space-x-4"
          >
        ...
        <View>
          <TouchableOpacity className="py-[12px] h-[48px] w-[361px] flex-row space-x-4">
