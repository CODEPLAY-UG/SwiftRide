...
import { featureCollection, point, Feature, Point } from "@turf/helpers";
...
export default function MapboxComponent() {
  ...
  const [isRideDetailsOpen, setIsRideDetailsOpen] = useState<boolean>(false);
...
const MapContent: React.FC<MapContentProps> = ({
  ...
  const BottomSheetHeader: React.FC<{ title: string }> = ({ title }) => (
  ...
  const points: Feature<Point>[] = bikes.map((bike) =>
