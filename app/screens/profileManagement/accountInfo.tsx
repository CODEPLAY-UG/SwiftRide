    ...
    <View className="bg-white h-full w-full px-4">
      ...
      <View className="space-y-8 mt-[16px]">
        <View className="flex-row justify-between items-center">
          <View className="mx-4">
            <Text className="text-[#616161]  text-[13px] font-normal leading-[18px] py-[5px] tracking-tighter[-0.08]">
              Name
            </Text>
            <TextInput
        ...
        <View className="flex-row justify-between items-center">
          <View className="mx-4">
            ...
            <TextInput
              className="text-[#242424] text-[17px] mt-1 py-2 caret-black font-normal leading-[22px] tracking-[-0.43px] border-b-[1px] border-b-[#D1D1D1]"
