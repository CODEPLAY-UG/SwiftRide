        ...
        <View className="flex-row justify-between items-center px-5 ">
          ...
          <View className="mx-4">
            <Text className="text-[#616161] text-[13px] font-normal leading-[18px] tracking-tighter[-0.08]">
              Select how drivers can contact you during trips and how you'd like
              to receive special offers, promotions, and more.
            </Text>
          </View>
        </View>
        ...
        <View className="space-y-4 px-4">
          <View className="flex-row justify-between items-center">
            ...
            <View className="bg-[#F1FAF1] py-[2] px-[8] rounded-[4px]">
              <Text className="text-[#0E700E] text-[15px] font-normal leading-[20px] tracking-[-0.23]">
                Recommended
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row justify-between items-center px-4">
            <View className="flex-row items-center ">
              ...
              <View className="mx-4">
                ...
                <Text className="text-[#616161] text-[13px] font-normal leading-[18px] tracking-tighter[-0.08]">
                  Exciting product updates and news.
                </Text>
              </View>
            </View>
          </View>
